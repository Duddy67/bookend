...
class Book extends Model
{
    ...
    {
        // Deletes ordering rows linked to the deleted book.
	...
	// NB: By default, the current page is detected by the value of the page query string argument on the HTTP request.
