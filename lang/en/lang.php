...
return [
    ...
    'settings' => [
      ...
      'books_description' => 'Displays a list of books filtered by one or more categories.',
      ...
      'books_filter_description' => 'Enter a category slug or URL parameter to filter the books by. 
				     You can also enter a category id or a comma-separated list of category ids to filter the books by.
                                     Leave empty to show all books.',
      'books_category_ids_validation' => 'Ids must be a category id, or a comma-separated list of ids',
      ...
      'books_show_categories_description' => 'Show the sub-categories (if any) of the category. 
                                              Only available when books are filtered by a single category.',
      ...
      'books_except_categories_description' => 'Enter a comma-separated list of category ids with such a list of categories you want to exclude.',
      'books_except_categories_validation' => 'Category exceptions must be a single category slug, or a comma-separated list of slugs.',
      'books_hide_categories' => 'Hide categories of the books',
      'books_hide_categories_description' => 'Enter a comma-separated list of category ids with such a list of categories you want to hide.',
      ...
      'invalid_file_name' => 'Invalid file name.
			      ...
			      The numeric value refers to the depht of the category path.
                              To cancel this warning, please disable the "Hierarchical URL" option in the Bookend global settings or filter books by category ids.',
    ],
    'global_settings' => [
      'tab_general' => 'General',
      'max_characters' => 'Max characters',
      'max_characters_comment' => 'The maximum number of characters to display in book list view',
